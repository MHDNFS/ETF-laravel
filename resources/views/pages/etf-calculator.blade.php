...
@section('content')
    ...
    <div class="content page-animate">
      ...
      <x-page-header title="ETF Calculator" subtitle="Compute NAV, total expense ratio, tracking error, and projected returns" />
      <div class="grid-2">
        <div class="card">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <x-etf-results-panel />
            <x-etf-projection-chart />
            <x-etf-result-details />
          </div>
        </div>
      </div>
    </div>
