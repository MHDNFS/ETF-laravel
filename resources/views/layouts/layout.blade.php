...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=DM+Mono:wght@300;400;500&family=Syne:wght@400;500;600;700;800&family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;1,9..40,300&display=swap" rel="stylesheet">
...
<div id="app">
  ...
  {{-- <nav class="sidebar" id="sidebar">
    ...
    <a class="nav-item" href="profile.html"><span class="nav-icon"><i class="fa-solid fa-user-circle"></i></span>My Profile</a>
    <div class="sidebar-section">ETF Module</div>
    <a class="nav-item" href="etf-calculator.html"><span class="nav-icon"><i class="fa-solid fa-calculator"></i></span>ETF Calculator</a>
    <a class="nav-item" href="etf-funds.html"><span class="nav-icon"><i class="fa-solid fa-layer-group"></i></span>Fund Explorer<span class="nav-badge">12</span></a>
    <div class="sidebar-section">PTF Module</div>
    <a class="nav-item" href="ptf-calculator.html"><span class="nav-icon"><i class="fa-solid fa-sliders"></i></span>PTF Calculator</a>
    ...
    <div class="sidebar-profile">
      ...
      <a href="index.html" class="sidebar-profile-btn" title="Logout"><i class="fa-solid fa-arrow-right-from-bracket"></i></a>
    </div>
  </nav> --}}

  @php
    // Provide default values if the view does not pass sidebar data.
    // This keeps the layout working for all pages.
    ...
    {{-- <div class="content page-animate">
      ...
      <div class="grid-6040">
        <div class="card">
          <div class="card-header">
            ...
            <select style="background:var(--bg3);border:1px solid var(--border2);border-radius:6px;padding:4px 10px;color:var(--text2);font-size:12px;outline:none;cursor:pointer">
              <option>1 Month</option><option>3 Months</option><option selected>1 Year</option><option>3 Years</option>
            </select>
          </div>
          <div class="card-body">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div style="margin-top:14px">
              <div class="alloc-item"><div class="alloc-dot" style="background:#4f8cff"></div><div class="alloc-name">US Equities</div><div class="alloc-pct">42%</div><div class="alloc-bar-wrap"><div class="progress-bar"><div class="progress-fill" style="width:42%;background:#4f8cff"></div></div></div></div>
              <div class="alloc-item"><div class="alloc-dot" style="background:#00d4aa"></div><div class="alloc-name">Bonds</div><div class="alloc-pct">26%</div><div class="alloc-bar-wrap"><div class="progress-bar"><div class="progress-fill" style="width:26%;background:#00d4aa"></div></div></div></div>
              <div class="alloc-item"><div class="alloc-dot" style="background:#7b5ea7"></div><div class="alloc-name">Intl Markets</div><div class="alloc-pct">19%</div><div class="alloc-bar-wrap"><div class="progress-bar"><div class="progress-fill" style="width:19%;background:#7b5ea7"></div></div></div></div>
              <div class="alloc-item"><div class="alloc-dot" style="background:#f59e0b"></div><div class="alloc-name">Commodities</div><div class="alloc-pct">13%</div><div class="alloc-bar-wrap"><div class="progress-bar"><div class="progress-fill" style="width:13%;background:#f59e0b"></div></div></div></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button class="btn btn-blue btn-sm" onclick="showModal('add-trade-modal')"><i class="fa-solid fa-plus"></i> Add Trade</button>
        </div>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td class="td-mono">120</td><td class="td-mono">$512.40</td>
                <td class="td-mono" style="font-weight:500">$61,488</td>
                <td><span class="badge badge-green"><i class="fa-solid fa-circle" style="font-size:7px"></i> Settled</span></td>
              ...
              <tr>
                ...
                <td><div class="fund-name">iShares Core MSCI</div><div class="fund-ticker">IEMG</div></td>
                <td><span class="tag tag-etf">ETF</span></td>
                <td class="td-mono">85</td><td class="td-mono">$54.22</td>
                <td class="td-mono" style="font-weight:500">$4,609</td>
                <td><span class="badge badge-amber"><i class="fa-solid fa-circle" style="font-size:7px"></i> Pending</span></td>
                <td><button class="btn btn-outline btn-sm" onclick="showModal('trade-detail-modal')">View</button></td>
              </tr>
              <tr>
                <td class="td-muted td-mono">2026-04-30</td>
                <td><div class="fund-name">Custom Growth Fund</div><div class="fund-ticker">CGF-A</div></td>
                <td><span class="tag tag-ptf">PTF</span></td>
                <td class="td-mono">200</td><td class="td-mono">$88.75</td>
              ...
              <tr>
                ...
                <td><div class="fund-name">SPDR Gold ETF</div><div class="fund-ticker">GLD</div></td>
                <td><span class="tag tag-etf">ETF</span></td>
                <td class="td-mono">40</td><td class="td-mono">$224.10</td>
                <td class="td-mono" style="font-weight:500">$8,964</td>
                <td><span class="badge badge-red"><i class="fa-solid fa-circle" style="font-size:7px"></i> Cancelled</span></td>
                <td><button class="btn btn-outline btn-sm" onclick="showModal('trade-detail-modal')">View</button></td>
              </tr>
              <tr>
                ...
                <td><span class="tag tag-ptf">PTF</span></td>
                <td class="td-mono">500</td><td class="td-mono">$102.30</td>
